...
L["OPT_SHALLOW_FILL"]      = "浅层填充模式（实验性）"
L["OPT_SHALLOW_FILL_TIP"]  = "价格根据以下填充数量计算，而非标准的50,000件深层填充。对小批量会话可能显示更低价格，但在稀薄市场上不够稳定。仅用于比较参考，不替代默认模式。"
L["OPT_SHALLOW_FILL_QTY"]  = "填充数量："
L["OPT_SHALLOW_FILL_RANGE"] = "（250 - 50,000）"
L["SHALLOW_FILL_ACTIVE"]   = "[浅层填充] 拍卖行 %s 件价格（实验性）"
