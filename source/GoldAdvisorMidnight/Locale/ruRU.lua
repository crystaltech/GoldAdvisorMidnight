...
L["OPT_SHALLOW_FILL"]      = "Режим поверхностного заполнения (Эксперим.)"
L["OPT_SHALLOW_FILL_TIP"]  = "Цены рассчитываются на основе количества заполнения ниже, вместо стандартного глубокого заполнения на 50 000 единиц. Может показывать более низкие цены для небольших сессий, но менее стабилен на тонких рынках. Используйте для сравнения — не замена стандартному режиму."
L["OPT_SHALLOW_FILL_QTY"]  = "Кол-во:"
L["OPT_SHALLOW_FILL_RANGE"] = "(250 - 50 000)"
L["SHALLOW_FILL_ACTIVE"]   = "[Пов. заполнение] Цена АД за %s ед. (эксперим.)"
