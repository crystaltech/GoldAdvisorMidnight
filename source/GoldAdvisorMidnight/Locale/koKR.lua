...
L["OPT_SHALLOW_FILL"]      = "얕은 채움 모드 (실험적)"
L["OPT_SHALLOW_FILL_TIP"]  = "가격이 표준 50,000개 깊은 채움 대신 아래 채움 수량으로 계산됩니다. 소량 거래 시 더 저렴한 가격을 표시할 수 있지만 얇은 시장에서는 불안정합니다. 비교용으로만 사용 — 기본 모드의 대체재가 아닙니다."
L["OPT_SHALLOW_FILL_QTY"]  = "채움 수량:"
L["OPT_SHALLOW_FILL_RANGE"] = "(250 - 50,000)"
L["SHALLOW_FILL_ACTIVE"]   = "[얕은 채움] 경매장 %s개 가격 (실험적)"
