...
L["TT_LBL_COST_BODY"]           = "경매장 가격 기준 전체 재료 비용(가방에 있는 아이템 포함)입니다. 이 값은 수익과 ROI의 스프레드시트 기준 비용입니다."
L["TT_LBL_BUY_NOW_COST_TITLE"]  = "지금 구매 비용"
L["TT_LBL_BUY_NOW_COST_BODY"]   = "가방과 은행에 이미 있는 아이템을 제외하고, 아직 구매해야 하는 재료의 비용만 표시합니다."
L["TT_LBL_PROFIT_BODY"]         = "순 수입에서 이미 보유한 재료를 포함한 모든 필요 재료의 전체 경매장 가치를 뺀 금액입니다."
