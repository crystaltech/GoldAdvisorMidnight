...
L["OPT_SHALLOW_FILL"]      = "Mode remplissage superficiel (Expérimental)"
L["OPT_SHALLOW_FILL_TIP"]  = "Les prix sont calculés à partir de la quantité de remplissage ci-dessous, au lieu du remplissage profond standard de 50 000 unités. Peut afficher des prix moins chers pour les petites sessions mais est moins stable sur les marchés peu actifs. À utiliser pour comparaison — pas un remplacement général du mode par défaut."
L["OPT_SHALLOW_FILL_QTY"]  = "Qté de remplissage :"
L["OPT_SHALLOW_FILL_RANGE"] = "(250 - 50 000)"
L["SHALLOW_FILL_ACTIVE"]   = "[Remplissage superficiel] Prix AH sur %s unités (expérimental)"
