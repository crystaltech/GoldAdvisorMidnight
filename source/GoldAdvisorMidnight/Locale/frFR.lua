...
L["TT_LBL_COST_BODY"]           = "Coût complet des réactifs aux prix de l'HV, y compris les objets déjà dans vos sacs. C'est la base de coût alignée sur le tableur pour le profit et le ROI."
...
L["TT_LBL_PROFIT_BODY"]         = "Revenu net moins la valeur HV complète de tous les matériaux requis, y compris ceux que vous possédez déjà."
