...
L["OPT_SHALLOW_FILL"]      = "Flacher Füll-Modus (Experimentell)"
L["OPT_SHALLOW_FILL_TIP"]  = "Preise werden auf Basis der unten eingestellten Füllmenge berechnet, statt der Standard-50.000-Einheiten-Tiefenfüllung. Kann für kleine Mengen günstigere Preise zeigen, ist aber auf dünnen Märkten weniger stabil. Zum Vergleich verwenden — kein genereller Ersatz für den Standard."
L["OPT_SHALLOW_FILL_QTY"]  = "Füllmenge:"
L["OPT_SHALLOW_FILL_RANGE"] = "(250 - 50.000)"
L["SHALLOW_FILL_ACTIVE"]   = "[Flacher Füll] %s-Einheiten AH-Preis (experimentell)"
