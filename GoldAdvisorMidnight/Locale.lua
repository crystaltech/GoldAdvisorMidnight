...
L["TT_SCAN_SELECTED_BODY"]  = "Queue the selected strategy's reagents and output items for AH price lookups. Shift-click to scan only the currently visible favorites."

-- Tooltips — Strategy Detail metric labels
L["TT_LBL_COST_TITLE"]       = "Total Cost"
L["TT_LBL_COST_BODY"]        = "Full upfront reagent value at AH prices, including items already in your bags. Resourcefulness savings are shown separately when V2 stats are available."
L["TT_LBL_EXPECTED_COST_TITLE"] = "Expected Cost"
L["TT_LBL_EXPECTED_COST_BODY"]  = "Average consumed material cost after Resourcefulness. V2 Profit, ROI, and Break-Even use this value when available."
...
L["TT_LBL_BREAKEVEN_BODY"]   = "The minimum LIST price on the AH so that after the 5% cut you recover the cost basis used for profit."
L["TT_LBL_STATS_TITLE"]      = "Resolved Craft Stats"
L["TT_LBL_STATS_BODY"]       = "Shows the stat profile, source, visible Multicraft/Resourcefulness, and hidden specialization bonuses used by V2."
